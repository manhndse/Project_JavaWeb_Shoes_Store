        ...
        <section class="gallery5 mbr-gallery cid-sfR564WcbO" id="gallery5-1i">
            ...
            <div class="container">
                <div class="mbr-section-head">
                    <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-2"><strong>Update Product</strong></h3>
                    ...
                    <div class="col-md-3">
                        <form  action="edit" method="post">
                            <div class="form-group">
                                ...
                                <input name="id" type="text" value="${p.getProductByID(param.id).id}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name</label>
                                <input name="name" type="text" value="${p.getProductByID(param.id).name}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Unit</label>
                                <input name="unit" type="text" value="${p.getProductByID(param.id).unit}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Price</label>
                                <input name="price" type="text" value="${p.getProductByID(param.id).price}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Link Image</label>
                                <input name="image" type="text" value="${p.getProductByID(param.id).image}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
